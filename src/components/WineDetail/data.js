import wineMattwe from '../../assets/wine-mattwe.png';
...
export const wines = [
    {
        ...
        "description": "Creamos una línea de vinos únicos y elegantes, en donde cada uno es fruto del trabajo en un viñedo especial, por su edad y su manejo. Elaborado con uvas provenientes de nuestros viñedos centenarios plantados en 1906 y 1930.",
        "composition": "100% Cabernet.",
        "color": "Rojos con reflejos bordo",
    ...
    {
        "title": "NISOMA - Since 2018",
        "description": "Es el vino ícono de Bodega Wineberry. Busca complejidad y elegancia. Se elabora de uvas de bajos rendimientos, con largas maceraciones. Su crianza dura dos años en barricas nuevas de roble francés y un año de estiba en botella antes de salir al mercado.",
        "composition": "Malbec (Gualtallary) 56%, Cabernet Sauvignon (Gualtallary) 12.5% y Cabernet Sauvignon (Perdriel, Luján de Cuyo) 31.5%.",
        "color": "Rojo oscuro muy intenso.",
        "aroma": "Gran complejidad aromática, frutos rojos y negros maduros y en confituras, especias y roble muy elegante bien integrado.",
