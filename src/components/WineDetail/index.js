...
const WineDetail = ({title, description, composition, color, aroma, sabor, maridaje, background, img}) => {
    const goBack= () => {
        window.history.back();
    }
    return (
        <section className={`detail detail--${background}`}>
            ...
            <section className="detail__section detail__section--first">
                <h1 className="detail__section-title detail__section-title--primary ">{title}</h1>
            ...
            <section className="detail__section detail__section--third">
                ...
                <div className="detail__section-item">
                    <img className="icon--desktop" src={colorIconD} alt="Icon sabor"></img>
                    <img className="icon--mobile" src={colorIconM} alt="Icon color"></img>
                    <h3>Color:</h3>
                    <p>{color}</p>
                </div>
                <div className="detail__section-item">
                    <img className="icon--desktop" src={aromaIconD} alt="Icon sabor"></img>
                    <img className="icon--mobile" src={aromaIconM} alt="Icon aroma"></img>
                    <h3>Aroma:</h3>
                    <p>{aroma}</p>
                </div>
                <div className="detail__section-item">
                    <img className="icon--desktop" src={saborIconD} alt="Icon sabor"></img>
            ...
            <section className="detail__section detail__section--fifth">
                <button onClick={goBack} className="detail__section-button">Volver</button>
